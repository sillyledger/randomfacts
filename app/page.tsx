      ...
      <div className="flex w-full max-w-[390px] flex-1 flex-col">
        ...
        <div className="mt-8 flex gap-3">
          <button
            ...
            className="flex-1 rounded-full border border-white/15 py-3.5 text-sm font-semibold text-white/90 transition hover:bg-white/5"
          >
            ← Back
          </button>
          <button
        ...
        <div className="mt-10 flex justify-center pb-4">
          <span className="text-xs font-semibold tracking-wide text-white/30">Random Facts</span>
        </div>
      </div>
    </main>
  );
